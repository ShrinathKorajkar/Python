...
import smtplib, imapclient, pyzmail, logging, traceback, time, subprocess, os

os.chdir(os.path.dirname(__file__))

logging.basicConfig(filename='torrentStarterLog.txt',
                    level=logging.DEBUG,
